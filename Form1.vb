...
Public Class Form1
    ...
    Public Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        toolTip1.SetToolTip(Me.Label1, "Select one of pre-defined program or create new")
        toolTip1.SetToolTip(Me.Label3, "Set the Motor 2 parameters")
        ...
        toolTip1.SetToolTip(Me.Label7, "Set the time delay of Motor 1 cycle restart")
        toolTip1.SetToolTip(Me.Label29, "If device restart is required after the front pedal is pressed, turn it on")
        toolTip1.SetToolTip(Me.Label2, "Set the maximum idle running time in minute")
        ...
        toolTip1.SetToolTip(Me.btnMOTOR1, "Test Motor 1")
        toolTip1.SetToolTip(Me.btnMOTOR2, "Test Motor 2")
        toolTip1.SetToolTip(Me.btnLIGHT1, "Test Light 1")
        toolTip1.SetToolTip(Me.btnLIGHT2, "Test Light 2")
        toolTip1.SetToolTip(Me.btnAlarm, "Test Alarm")
